...
if (isset($_POST['submit'])) {
	...
	$sql = "INSERT INTO BCSWN_COMPLAIN(COMPLAIN_ID, COMPLAIN_SUBJECT, COMPLAIN_DESC,USER_ID ) VALUES(COM_INC.NEXTVAL, '" . $C_NAME . "','" . $C_DESCRIPTION . "',".$W_ID.")";
								...
								<div class="card " style="width: 95%; ">
									<div class="card-header " style="background-color: #C0C0C0!important;">
										<div class="d-flex justify-content-center align-items-center">
											<p class="section_part btn btn-link" id="section_12_label" style="font-size:2vw;">Section : Complain Box
											</p>
										</div>
										...
										<form action="" method="post">
											...
											<div class="row mt-2">
												...
												<div class="col-lg-12 col-md-12 col-sm-12">
													...
													<textarea class="form-control" id="c_description" name="c_description" rows="4" cols="50">
