...
$sql3 = "SELECT * FROM BCSWN_DISTRICT";
...
$sql5 = "SELECT * FROM BCSWN_CADRE";
$parse = ociparse($conn, $sql5);
oci_execute($parse);
...
$sql6 = "SELECT * FROM BCSWN_BATCH";
$parse = ociparse($conn, $sql6);
oci_execute($parse);
...
$sql6 = "SELECT * FROM BCSWN_INTEREST";
$parse = ociparse($conn, $sql6);
oci_execute($parse);
...
$sql7 = "SELECT * FROM BCSWN_DEGREE";
$parse = ociparse($conn, $sql7);
oci_execute($parse);
...
if (isset($_POST['submit'])) {
	...
	$q = "SELECT COUNT(*) AS C_M FROM BCSWN_USER WHERE MOBILE='".$W_MOBILE."'";
	$n= ociparse($conn, $q);
	oci_execute($n);
	...
	$sql1 = "INSERT INTO BCSWN_USER(ID,NAME,DOB,BLOOD,MOBILE,EMAIL,SKILL,INTEREST,DESIGNATION,POSTING,CADRE,BATCH,MEMBERSHIP,HONOR,ARTICLE,MARRIGE,PICTURE,SIGNATURE,SSC_EXAM,SSC_BOARD,SSC_ROLL,SSC_RESULT,SSC_GROUP,SSC_PASSING,HSC_EXAM,HSC_BOARD,HSC_ROLL,HSC_RESULT,HSC_GROUP,HSC_PASSING,GRAD_EXAM,GRAD_SUBJECT,GRAD_UNIVERSITY,GRAD_RESULT,GRAD_PASSING,GRAD_DURATION,MST_EXAM,MST_SUBJECT,MST_UNIVERSITY,MST_RESULT,MST_PASSING,MST_DURATION,O_ADDRESS,O_DIVISION,O_DISTRICTS,O_UPAZILLA,R_ADDRESS,R_DIVISION,R_DISTRICTS,R_UPAZILLA,P_ADDRESS,P_DIVISION,P_DISTRICTS,P_UPAZILLA,CHILD_BOY,CHILD_GIRL) VALUES (INC.NEXTVAL,'" . $W_NAME . "',TO_DATE('" . $W_DOB . "', 'YYYY-MM-DD'),'" . $W_BLOOD . "','" . $W_MOBILE . "','" . $W_EMAIL . "','" . $W_SKILL . "','" . $W_INTEREST . "','" . $W_DESIGNATION . "','" . $W_POSTING . "', '" . $W_CADRE . "','" . $W_BATCH . "','" . $W_MEMBERSHIP . "','" . $W_HONOR . "','" . $W_ARTICLE . "','" . $W_MARRIGE . "', '" . $W_PICTURE . "','" . $W_SIGNATURE . "','" . $W_SSC_EXAMINATION . "','" . $W_SSC_BOARD . "','" . $W_SSC_ROLL . "','" . $W_SSC_RESULT . "','" . $W_SSC_GROUP . "','" . $W_SSC_PASSING_YEAR . "','" . $W_HSC_EXAMINATION . "','" . $W_HSC_BOARD . "','" . $W_HSC_ROLL . "','" . $W_HSC_RESULT . "','" . $W_HSC_GROUP . "','" . $W_HSC_PASSING_YEAR . "','" . $W_GRADUATION_EXAMINATION . "','" . $W_GRADUATION_SUBJECT . "','" . $W_GRADUATION_UNIVERSITY . "','" . $W_GRADUATION_RESULT . "','" . $W_GRADUATION_PASSING_YEAR . "','" . $W_GRADUATION_COURSE_DURATION . "','" . $W_MASTER_EXAMINATION . "','" . $W_MASTER_SUBJECT . "','" . $W_MASTER_UNIVERSITY . "','" . $W_MASTER_RESULT . "','" . $W_MASTER_PASSING_YEAR . "','" . $W_MASTER_COURSE_DURATION . "','" . $W_O_ADDRESS . "','" . $W_O_DIVISION . "','" . $W_O_DISTRICT . "','" . $W_O_UPAZILLA . "','" . $W_R_ADDRESS . "','" . $W_R_DIVISON . "','" . $W_R_DISTRICT . "','" . $W_R_UPAZILLA . "','" . $W_P_ADDRESS . "','" . $W_P_DIVISION . "','" . $W_P_DISTRICT . "','" . $W_P_UPAZILLA . "','" . $W_CHILD_BOYS . "','" . $W_CHILD_GIRLS . "')";

	// $sql1="INSERT INTO BCSWN_USER(ID,NAME,DOB,BLOOD,MOBILE,EMAIL,SKILL,INTEREST,DESIGNATION,POSTING,CADRE,BATCH,MEMBERSHIP,HONOR,ARTICLE,MARRIGE,PICTURE,SIGNATURE,SSC_EXAM,SSC_BOARD,SSC_ROLL,SSC_RESULT,SSC_GROUP,SSC_PASSING,HSC_EXAM,HSC_BOARD,HSC_ROLL,HSC_RESULT,HSC_GROUP,HSC_PASSING,GRAD_EXAM,GRAD_SUBJECT,GRAD_UNIVERSITY,GRAD_RESULT,GRAD_PASSING,GRAD_DURATION,MST_EXAM,MST_SUBJECT,MST_UNIVERSITY,MST_RESULT,MST_PASSING,MST_DURATION,O_ADDRESS,O_DIVISION,O_DISTRICTS,O_UPAZILLA,R_ADDRESS,R_DIVISION,R_DISTRICTS,R_UPAZILLA,P_ADDRESS,P_DIVISION,P_DISTRICTS,P_UPAZILLA,CHILD_BOY,CHILD_GIRL) VALUES (INC.NEXTVAL,'".$W_NAME."',TO_DATE('" . $W_DOB . "', 'YYYY-MM-DD'),'".$W_BLOOD ."','".$W_MOBILE ."','".$W_EMAIL ."','".$W_SKILL ."','".$W_INTEREST ."','".$W_DESIGNATION ."','".$W_POSTING ."', '".$W_CADRE ."','".$W_BATCH ."','".$W_MEMBERSHIP ."','".$W_HONOR ."','".$W_ARTICLE ."','".$W_MARRIGE ."','".$W_PICTURE."','".$W_SIGNATURE."','".$W_SSC_EXAMINATION."','".$W_SSC_BOARD."','".$W_SSC_ROLL."','".$W_SSC_RESULT."','".$W_SSC_GROUP."','".$W_SSC_PASSING_YEAR."','".$W_HSC_EXAMINATION."','".$W_HSC_BOARD."','".$W_HSC_ROLL."','".$W_HSC_RESULT."','".$W_HSC_GROUP."','".$W_HSC_PASSING_YEAR."','".$W_GRADUATION_EXAMINATION."','".$W_GRADUATION_SUBJECT."','".$W_GRADUATION_UNIVERSITY."','".$W_GRADUATION_RESULT."','".$W_GRADUATION_PASSING_YEAR."','".$W_GRADUATION_COURSE_DURATION."','".$W_MASTER_EXAMINATION."','".$W_MASTER_SUBJECT."','".$W_MASTER_UNIVERSITY."','".$W_MASTER_RESULT."','".$W_MASTER_PASSING_YEAR."','".$W_MASTER_COURSE_DURATION."','".$W_O_ADDRESS."','".$W_O_DIVISION."','".$W_O_DISTRICT."','".$W_O_UPAZILLA."','".$W_R_ADDRESS."','".$W_R_DIVISON."','".$W_R_DISTRICT."','".$W_R_UPAZILLA."','".$W_P_ADDRESS."','".$W_P_DIVISION."','".$W_P_DISTRICT."','".$W_P_UPAZILLA."','".$W_CHILD_BOYS."','".$W_CHILD_GIRLS."')";

	// $sql1="INSERT INTO BCSWN_USER(ID,NAME,DOB,BLOOD,MOBILE) VALUES (INC.NEXTVAL,'".$W_NAME."',TO_DATE('" . $W_DOB . "', 'YYYY-MM-DD'),'".$W_BLOOD ."','".$W_MOBILE ."')";
	// print_r($sql1);
	// insert sql ends
...
<body>
	<div id="wrapper">
		...
		<!-- <li class="">
					...
					<li class="h" >
						<a  class="nav-link text-left" role="button" href="#"  >
							<i class="fas fa-user pr-2" style="color: #6aa364;"></i> <label style="color: #6aa364;" > Profile </label>
						</a>
					</li>

					<li class="h">
						<a class="nav-link text-left" role="button" href="./event_list.php">
		...
		<!-- Page Content -->
		<div id="page-content-wrapper row">
			<div id="content">
					...
					<nav class="navbar navbar-expand navbar-light bg-dark my-navbar">
						...
						<div class="row text-center col-12">
							...
							<div style="margin: 0 auto; padding: 20px!important; ">
								...
								<h1 class="d-inline "> <b class="text-white " style="position:relative; top:10px;  text-shadow: 3px 3px 5px rgba(150, 150, 150, 1); font-size:3.5vw;">
...
<h1 class="text-white text-center d-inline" style="padding: 20px; margin-top:5px;"><b class="text-center" style="text-shadow: 3px 3px 5px rgba(150, 150, 150, 1); font-size:3.5vw;">বিসিএস
	উইমেন নেটওয়ার্ক</b></h1> -->
					...
					<div class="row col-12 m-0">
						<!-- form stars 		 -->
						<form action="" method="POST" enctype="multipart/form-data" class="col-12" style="margin: 0 auto">
										...
										<div class="card-body" id="section_1_content">
											...
											<div class="row">
												...
												<div class="form-group col-6 pl-0">
													...
													<input type="number" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==11) return false;" class="form-control" name="mobile" id="mobile" value="<?php echo $W_MOBILE; ?>" placeholder="Mobile Number" required>
												</div>
												<!-- mobile ends  -->
											</div>
												...
												<div class="form-group col-lg-4 col-md-4 col-sm-12 pl-0">
													...
													<div>
														<select class="form-control" name="blood" id="blood">
															...
															<?php
															for ($i = 0; $i < count($W_BLOOD); $i++) {

																echo "<option value='" . $W_BLOOD[$i]["BLOOD_ID"] . "'>" . $W_BLOOD[$i]["BLOOD_NAME"] . "</option>";
															}
												...
												<div class="col-12">
													...
													<div class="form-group row">
														<label for="office" class="col-sm-2 col-form-label">Office
															:</label>
														<div class="col-sm-6">
															<input type="text" class="form-control" name="o_address" id="office" placeholder="Office Address" value="<?php echo  $W_OFFICE; ?>">
														...
														<div class="col-6">
															<div class="row">
																<label for="residence" class="col-sm-4 col-form-label">Residence
																	:</label>
																<div class="col-sm-8">
																	<input type="text" class="form-control" name="r_address" id="residence" placeholder="Residence Address" value="<?php echo  $W_RESIDENCE; ?>">
																</div>
															</div>
															<!-- division starts  -->
															<div class="row mt-2">
														...
														<div class="col-6">
															<div class="row">
																<label for="parmanent" class="col-sm-4 col-form-label">Permanent
																	:</label>
																<div class="col-sm-8">
																	<input type="text" class="form-control" name="p_address" id="parmanent" placeholder="Parmanent Address" value="<?php echo  $W_RESIDENCE; ?>">
																</div>
															</div>
															<!-- division starts  -->
															<div class="row mt-2">
										...
										<div class="card-body" id="section_6_content">
											...
											<div class="form-group">
												...
												<select class="form-control" name="interest" id="interest">
													<option value="">Select Interest & Hobbies</option>
													<?php
								...
								<div class="col-12">
									<div class="card " style="width: 95%">
										...
										<div class="card-body" id="section_8_content">
											<!-- membership starts -->
											<div class="form-group">
												<label class="form-label" for="membership">Proffesional
													Membership:</label>
								...
								<div class="col-12">
									<div class="card " style="width: 95%">
										...
										<div class="card-body" id="section_9_content">
											<!-- honor starts -->
											<div class="form-group">
												<label class="form-label" for="honor">Honors & Awards
													Received:</label>
								...
								<div class="col-12">
									<div class="card " style="width: 95%">
										...
										<div class="card-body" id="section_10_content">
											<!-- article starts -->
											<div class="form-group">
												<label class="form-label" for="article">Publications &
													Articles:</label>
										...
										<div class="card-body" id="section_11_content">
											...
											<div class="form-group">
												...
												<div class="row">
													<div class="col-6">
														<label>Boy/s :</label>
														<input type="number" min="0" class="form-control col-6" placeholder="Number Of Boy" name="child_boy" id="child" value="<?php echo  $W_CHILD; ?>">

													</div>
													<div class="col-6">

														<label>Girl/s :</label>
														<input type="number" min="0" class="form-control col-6" placeholder="Number Of Girl" name="child_girl" id="child" value="<?php echo  $W_CHILD; ?>">
							...
							<div class="container mt-4 col-4">
								...
								<button type='submit' class='btn btn-md btn-primary btn-block' name='submit' id='submit'> <b>
										Save</b></button>
