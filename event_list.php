...
<?php
   ...
   $sql = "SELECT * FROM BCSWN_EVENT ORDER BY E_ID DESC";
   $parseresult= ociparse($conn,$sql);
    ociexecute($parseresult);
	...
	<div id="wrapper">
		...
		<div id="page-content-wrapper">
			<div id="content">
                                    ...
                                    <div class="card-header " style="background-color: #C0C0C0!important;">
                                        <div class="d-flex justify-content-center align-items-center">
                                            <p class="section_part btn btn-link" id="section_12_label"
                                                style="font-size:2vw;">Section : Event List
                                            </p>
                                        </div>
                                              ...
                                              <tbody>
                                                <?php
                                                 for($i = 0; $i<count($output);$i++){
                                                     ?>
                                                         <tr>
                                                           <td> <?php echo $output[$i]['E_ID'] ?> </td>
                                                           <td> <?php echo $output[$i]['E_NAME'] ?> </td>
                                                           <td> <?php echo $output[$i]['E_DATE'] ?> </td>
                                                           <td> <?php echo $output[$i]['E_DESCRIPTION'] ?> </td>
                                                           <td> <?php echo $output[$i]['E_CHARGE'] ?> </td>
                                                         </tr>
                                                     <?php
                                                 }
				...
				<footer class="footer mt-4 bg-dark" style=" width:100%; position: absolute; bottom:0;font-weight: bold; text-shadow: 3px 3px 5px rgba(150, 150, 150, 1); ">
