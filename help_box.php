...
if (!isset($_SESSION['MOBILE'])) {
	...
	$sql = "SELECT * FROM TEST.BCSWN_USER WHERE MOBILE='" . $W_MOBILLE . "'";
...
if (isset($_POST['submit'])) {
	...
	$sql = "INSERT INTO BCSWN_HELP(HELP_ID, HELP_SUBJECT, HELP_DESC, HELP_END ) VALUES(HELP_INC.NEXTVAL, '" . $H_NAME . "','" . $H_DESCRIPTION . "', TO_DATE('" . $H_DATE . "', 'YYYY-MM-DD'))";
            ...
            <div id="content">
                <div class="container-fluid p-0 px-lg-0 px-md-0">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-dark my-navbar">
                        ...
                        <h1 class="text-white text-center d-inline" style="padding: 20px; margin-top:5px;"><b
                                style="text-shadow: 3px 3px 5px rgba(150, 150, 150, 1); font-size:3.5vw">বিসিএস
                                ...
                                <div class="card " style="width: 95%; ">
                                    <div class="card-header " style="background-color: #C0C0C0!important;">
                                        <div class="d-flex justify-content-center align-items-center">
                                            <p class="section_part btn btn-link" id="section_12_label"
                                                style="font-size:2vw;">Section : Help Box
                                            </p>
                                        </div>
                                        ...
                                        <form action="" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-md-3 col-sm-12">
                                                    ...
                                                    <input class="form-control" type="date" id="h_date" name="h_date">
                                            ...
                                            <div class="row mt-2">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    ...
                                                    <textarea class="form-control" id="h_description" name="h_description"
                                                        rows="4" cols="50">
                    ...
                    <footer class="footer  bg-dark"
                        style="margin-top: 100px; font-weight: bold; text-shadow: 3px 3px 5px rgba(150, 150, 150, 1);  width: 100%;">
