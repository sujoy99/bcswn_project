...
$sql6 = "SELECT * FROM BCSWN_BATCH ORDER BY BATCH_ID DESC";
...
// view particular data starts 
	...
	while ($row = oci_fetch_assoc($parseresult)) {
		...
		if($W_INTEREST != null){
			$t = "SELECT INTEREST_ID FROM BCSWN_INTEREST WHERE INTEREST_NAME='". $W_INTEREST."'";
	...
	oci_free_statement($b);
		...
		if($W_CADRE != null){
			$t = "SELECT CADRE_ID FROM BCSWN_CADRE
			WHERE CADRE_NAME='". $W_CADRE."'";
	...
	oci_free_statement($b);
		...
		if($W_BATCH != null){
			$t = "SELECT BATCH_ID FROM BCSWN_BATCH
			WHERE BATCH_NAME='". $W_BATCH."'";
	...
	oci_free_statement($b);
		...
		// echo $W_GRADUATION_EXAMINATION;
		if($W_GRADUATION_EXAMINATION != null){
			$X = "SELECT DEGREE_ID FROM BCSWN_DEGREE
			WHERE DEGREE_NAME='" . $W_GRADUATION_EXAMINATION . "'";
	...
	oci_free_statement($b);
		...
		// echo $W_GRADUATION_SUBJECT;

		if($W_GRADUATION_SUBJECT != null){
			$X = "SELECT SUBJECT_ID FROM BCSWN_SUBJECT

			WHERE SUBJECT_NAME='" . $W_GRADUATION_SUBJECT . "'";
	...
	oci_free_statement($b);
		...
		// echo $W_GRADUATION_UNIVERSITY;

		if($W_GRADUATION_UNIVERSITY != null){
			$X = "SELECT UNI_ID FROM BCSWN_UNI WHERE UNI_NAME='" . $W_GRADUATION_UNIVERSITY . "'";
	...
	oci_free_statement($b);
		...
		// echo $W_MASTER_EXAMINATION;


		if($W_MASTER_EXAMINATION != null){
			$X = "SELECT DEGREE_ID FROM BCSWN_DEGREE
			WHERE DEGREE_NAME='" . $W_MASTER_EXAMINATION . "'";
	...
	oci_free_statement($b);
		...
		if($W_MASTER_SUBJECT != null){
			...
			WHERE SUBJECT_NAME='" . $W_MASTER_SUBJECT . "'";
	...
	oci_free_statement($b);
		...
		// echo $W_MASTER_UNIVERSITY;


		if($W_MASTER_UNIVERSITY != null){
			$X = "SELECT UNI_ID FROM BCSWN_UNI


			WHERE UNI_NAME='" . $W_MASTER_UNIVERSITY . "'";
...
if ($W_BLOOD != null) {
	...
	$a = "SELECT BLOOD_ID FROM BCSWN_BLOOD WHERE BLOOD_NAME='" . $W_BLOOD . "'";
...
// $W_PASSWORD = $_POST['pass'];
	...
	GRAD_UNIVERSITY='" . $W_GRADUATION_UNIVERSITY . "', 
	...
	MST_UNIVERSITY='" . $W_MASTER_UNIVERSITY . "', 
										...
										<div class="card-body" id="section_1_content">
											...
											<div class="row">
												...
												<div class="form-group col-6 pl-0">
													...
													<input type="text" maxLength="11" class="form-control" name="mobile" id="mobile" value="<?php echo $W_MOBILE; ?>" placeholder="Mobile Number" required readonly>
												</div>
												<!-- mobile ends  -->
											</div>
...
if ($W_BLOOD != null) {
?>
	<option value="<?php echo $BLOOD_ID ?>" selected><?php echo $W_BLOOD ?></option>
<?php
}
...
?>
															...
															for ($i = 0; $i < count($BLOOD); $i++) {
																...
																echo "<option value='" . $BLOOD[$i]["BLOOD_ID"] . "'>" . $BLOOD[$i]["BLOOD_NAME"] . "</option>";
															}
													...
													<div class="row">
														...
														<div class="col-md-6 col-lg-6 col-sm-12 card">
															...
															<div class="form-group ">
																...
																<label>Roll : </label>
																<input type="text" class="form-control" placeholder="Batch" name="h_roll" id="batch" value="<?php echo  $W_HSC_ROLL; ?>">
															</div>
															...
															<div class="row">
																<div class="col-md-6 col-lg-6 col-sm-12">
																	...
																	<div class="form-group ">
																		...
																		<option  value="<?php echo $G_D_ID?>" selected><?php echo $W_GRADUATION_EXAMINATION?></option>
																	<?php
																		}
																	?>
																			<option value="" >Select
																	...
																	<div class="form-group ">
																		...
																		<option  value="<?php echo $G_S_ID?>" selected><?php echo $W_GRADUATION_SUBJECT?></option>
																	<?php
																		}
																	?>
																	...
																	<div class="form-group ">
																		...
																		<option  value="<?php echo $G_U_ID?>" selected><?php echo $W_GRADUATION_UNIVERSITY?></option>
																	<?php
																		}
																	?>
																			<option value="">Select
															...
															<div class="col-md-6 col-lg-6 col-sm-12">
																...
																<div class="form-group ">
																	...
																	<?php 
																		...
																		<option  value="<?php echo $M_D_ID?>" selected><?php echo $W_MASTER_EXAMINATION?></option>
																	<?php
																		}
																	?>
																		<option value="" >Select One
																...
																<div class="form-group ">
																	...
																	<?php 
																		...
																		<option  value="<?php echo $M_S_ID?>" selected><?php echo $W_MASTER_SUBJECT?></option>
																	<?php
																		}
																	?>
																		<option value="">Choose...</option>
																...
																<div class="form-group ">
																	...
																	<?php 
																		...
																		<option  value="<?php echo $M_U_ID?>" selected><?php echo $W_MASTER_UNIVERSITY?></option>
																	<?php
																		}
																	?>
																		<option value="" >Select One
										...
										<div class="card-body" id="section_6_content">
											...
											<div class="form-group">
												...
												<?php
																...
																if ($W_INTEREST != null) {
																?>
																	<option value="<?php echo $INTEREST_ID ?>" selected><?php echo $W_INTEREST ?></option>
																<?php
																}
											...
											<div class="row">
												...
												<div class="form-group col-4">
													...
													<?php
																...
																if ($W_CADRE != null) {
																?>
																	<option value="<?php echo $CADRE_ID ?>" selected><?php echo $W_CADRE ?></option>
																<?php
																}
												...
												<div class="form-group col-4 pl-0">
													...
													<?php
																...
																if ($W_BATCH != null) {
																?>
																	<option value="<?php echo $BATCH_ID ?>" selected><?php echo $W_BATCH ?></option>
																<?php
																}
