          ...
          <div>
                 ...
                 <a href="./u_profile.php"style="color: #6aa364;margin-left:150px"> <i class="fas fa-user pr-2" ></i>Profile </a>
                                    ...
                                    <li>
                                        ...
                                        <a href="./event_create.php" style="color: #6aa364;margin-left:120px"> <i
                                                class="fas fa-user pr-2"></i>Event Create </a>

                                    </li>
                                    <li>
                                        <a href="./member_list.php" style="color: #6aa364;margin-left:120px"><i
                                                class="fas fa-book pr-2"></i>Member List</a>

                                    </li>
                                    <li>
                                        <a href="./pending.php" style="color: #6aa364;margin-left:120px"> <i class="fas fa-bell pr-1" style="color: #6aa364;"></i>Pending List</a>

                                    </li>
                                    <li>
                                        <a href="./help_box.php" style="color: #6aa364;margin-left:120px"> <i
                                                class="fab fa-hire-a-helper"></i> Help Notice</a>

                                    </li>
                                    <li>
                                        <a href="./complain_view.php" style="color: #6aa364;margin-left:120px"><i
