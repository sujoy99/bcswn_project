...
$sql1="SELECT HELP_ID,HELP_SUBJECT,HELP_DESC,HELP_END FROM BCSWN_HELP WHERE TO_DATE(HELP_END)>=TO_DATE(SYSDATE)";
...
<body>
	<div id="wrapper">
									...
									<div class="card " style="width: 95%">
										<div class="card-header " style="background-color: #C0C0C0!important;">
											...
											<div class="d-flex justify-content-center align-items-center">
												<p class="section_part btn btn-link" id="section_1_label" style="font-size:2vw;">Section:Help View
												</p>
											</div>
        ...
        <thead>
		<tr>
			<th style="width:10% "> HELP ID</th>
			<th style="width:25%">HELP SUBJECT </th>
			<th style="width:50%">HELP DESCRIPTION</th>
        ...
        <tbody>
            ...
            <?php 
               ...
               ?>
                                         ...
                                         <tr>
                                                   <td style="text-align:center"><?php echo $output[$i]['HELP_ID']; ?></td>
																<td><?php echo $output[$i]['HELP_SUBJECT']; ?></td>
																<td ><?php echo $output[$i]['HELP_DESC']; ?></td>
																
																<td><?php echo $output[$i]['HELP_END']; ?></td>
