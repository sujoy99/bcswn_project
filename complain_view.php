...
$sql1 = "SELECT COMPLAIN_ID, COMPLAIN_SUBJECT, COMPLAIN_DESC, USER_ID, BCSWN_USER.NAME,TO_DATE( COMPLAIN_DATE, 'YYYY-MM-DD') AS COMPLAIN_DATE FROM BCSWN_COMPLAIN,BCSWN_USER WHERE BCSWN_COMPLAIN.USER_ID = BCSWN_USER
.ID";
		...
		<div id="page-content-wrapper">
			<div id="content">
				<div class="container-fluid p-0 px-lg-0 px-md-0">
					...
					<div class="row col-12 m-0" style="width: 100%;">
						...
						<div class="row container m-2 " >
							<div class="col-12">
								<div class="card " style="width: 100%">
									<div class="card-header " style="background-color: #C0C0C0!important; width:100%!important">

										<div class="d-flex justify-content-center align-items-center">
											<p class="section_part btn btn-link" id="section_1_label" style="font-size:2vw;">Section:Complain View
											</p>
										</div>

									</div>

									<div class="card-body" id="section_1_content" style="width: 100%!important">
										...
										<div class="row">
											<div class="col-lg-12 col-md-12 col-sm-12">
												...
												<!-- member show starts  -->
												<table id="table_id" class="display table-responsive-md" style="margin: 0 auto ; width:80%;table-layout:fixed">
													<thead>
														<tr>
															<th >COMPLAIN ID</th>
													...
													<tbody>
														...
														?>
															...
															<tr>
																<td class="text-center"><?php echo $output[$i]['COMPLAIN_ID']; ?></td>
																<td><?php echo $output[$i]['COMPLAIN_SUBJECT']; ?></td>
																<td><?php echo $output[$i]['COMPLAIN_DESC']; ?></td>
																<td><?php echo $output[$i]['USER_ID']; ?></td>
																<td><?php echo $output[$i]['NAME']; ?></td>
																<td><?php echo $output[$i]['COMPLAIN_DATE']; ?></td>
