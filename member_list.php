...
$sql1="SELECT*FROM BCSWN_USER WHERE STATUS='A'";
									...
									<div class="card " style="width:95%">
										<div class="card-header " style="background-color: #C0C0C0!important;">
											...
											<div class="d-flex justify-content-center align-items-center">
												<p class="section_part btn btn-link" id="section_1_label" style="font-size:2vw;"> Section:Member List
												</p>
											</div>
...
<tr>
				...
				<td><?php echo $output[$i]['APP_BY']; ?></td>
